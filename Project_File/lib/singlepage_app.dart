...
import 'package:firebase_realtimedb/ekran4.dart';
    ...
    return Scaffold(
      bottomNavigationBar: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.blue.withOpacity(0.2), // 0.5
              spreadRadius: 10, //2
              blurRadius: 18, // 5 alta alırsam daha düzleşir sayı artarsa geçiş yumuşar
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: ImageIcon(
              AssetImage('assets/yapayzeka.png'),
              size: 48.0, // İkonun boyutunu ayarlamak için size parametresini kullanın
            ),
            onPressed: () {
              Navigator.push(
                context,
        ...
        title: Center(
          child: Padding(
            padding: EdgeInsets.only(top: 16.0), // Üste uzaklık
            child: Column(
              ...
              children: [
                Text(
                  "Eco-Guardian",
                  style: TextStyle(
                    color: Colors.green[900], // Koyu yeşil renk
                    fontWeight: FontWeight.w900, // Daha kalın bir yazı stili
                    fontSize: 26.0,
                    fontFamily: 'Lato', // Uygun bir kalın yazı font ailesi
                  ),
                ),
                Text(
                  "Hoşgeldiniz",
                  style: TextStyle(
                    color: Colors.green[900], // Koyu yeşil renk
                    fontWeight: FontWeight.w700, // Kalın bir yazı stili
                    fontSize: 12.0,
                    fontFamily: 'Lato', // Uygun bir kalın yazı font ailesi
                  ),
                ),
          ...
          child: Container(
            ...
            child: TabBar(
              ...
              tabs: [
                ...
                Tab(
                  icon: Icon(
                    MaterialCommunityIcons.flower_outline,
                    color: Colors.black54,
                    size: 30.0,
                  ),
                ),
