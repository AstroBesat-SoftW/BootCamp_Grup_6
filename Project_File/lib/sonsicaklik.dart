...
// Add a listener to listen for the data being deleted.
  ...
  Future<void> _initializeVideoPlayer() async {
    _controller = VideoPlayerController.asset('assets/ust.mp4');
  ...
  Widget build(BuildContext context) {
   ...
   // }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        automaticallyImplyLeading: false, // Varsayılan geri okunu kaldırır
        backgroundColor: Colors.lightGreen[600],
        title: Column(
          children: [
            SizedBox(height: 0.0), // Yazı ile menü arasına boşluk ekledim
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                BackButton(color: Colors.white), // Geri tuşu eklendi
                Text(
                  "Eco-Guardian",
                  style: TextStyle(
                    color: Colors.green[900],
                    fontSize: 15.0, // Yazı boyutu
            ...
            SizedBox(height: 13.0), // Yazı ile menü arasına boşluk ekledim
          ],
        ),
      ),
                ...
                return Padding(
                  ...
                  child: AnimatedScale(
                    ...
                    child: Card(
                      ...
                      elevation: 10.0, // Daha belirgin gölge
                      ...
                      child: ListTile(
                        ...
                        leading: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8.0), // Space between icon and image
                            Image.asset(
                              'assets/bitki.png', // Your image path
                              width: 40.0,
                              height: 40.0,
                            ),
                          ...
                          /*  Container(
                              decoration: BoxDecoration(
                                ...
                                color: Colors.green[100], // Yuvarlak simge arka planı
                              ),
                              padding: EdgeInsets.all(12.0), // Simgeyi ortalamak için padding
                              child: Icon(
                                Icons.thermostat_outlined,
                                color: Colors.green[700], // green as plants
                                size: 20, // Simge boyutunu artırdık
                              ),
                            ),*/
                          ],
                        ),
                        title: Text(
                          '${dataList[index]} °C',
                          style: TextStyle(
                            fontSize: 18.0, // Yazı boyutunu artırdık
                            fontFamily: 'Montserrat',
                            fontWeight: FontWeight.bold,
                            color: Colors.green[700], // green as plants
                          ),
                        ...
                        trailing: IconButton(
                          icon: Icon(
                            ...
                            size: 30, // Simge boyutunu artırdık
                          ),
                          onPressed: () async {
                            // Remove the data from the dataList.
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            ...
            Text(
              'Kayıt Edilen Sıcaklık Verileri',
              style: TextStyle(
                fontSize: 16,
      ...
      appBar: AppBar(
        ...
        flexibleSpace: ClipPath(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 30.0), // AppBar'ın üst kısmına boşluk
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: <Widget>[
                    BackButton(color: Colors.white), // Geri tuşu eklendi
                ...
                SizedBox(height: 10.0), // Yazı ile menü arasına boşluk ekledim
                Container(
                  width: 40, // Genişlik
                  height: 40, // Yükseklik
                  decoration: BoxDecoration(
                  ...
                  child: Image.asset(
                    'assets/bitkimana.png', // Görselin yolu
                    fit: BoxFit.cover,
                  ),
                ),
              ],
        ...
        toolbarHeight: 140.0, // AppBar yüksekliği
      ),
                ...
                return Padding(
                  ...
                  child: AnimatedScale(
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        contentPadding: EdgeInsets.all(20.0), // İçeriği genişletmek için padding
                        leading: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            ...
                            SizedBox(width: 8.0), // Space between icon and image
                            Image.asset(
                              'assets/bitkimana.png', // Your image path
                              width: 90.0,
                              height: 90.0,
                            ),
